...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=vr5UHTQa#Y4prfCjWiktlr0V43s4_1h33krgqE-I31jSDJpJTBoQ' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
ALIVE_MSG: process.env.ALIVE_MSG === undefined ? "*Hello , I am alive now!!*" : process.env.ALIVE_MSG,
AUTO_READ_STATUS: process.env.AUTO_READ_STATUS === undefined ?"true" : process.env.AUTO_READ_STATUS,
MODE: process.env.MODE === undefined ?"privé" : process.env.MODE,
...
SEEDER_PASSWORD: process.env.SEEDER_PASSWORD === undefined ? "false" : process.env.SEEDER_PASSWORD,
BAD_NO_BLOCK: process.env.BAD_NO_BLOCK === undefined ? "false" : process.env.BAD_NO_BLOCK,  
POSTGRESQL_URL: process.env.POSTGRESQL_URL === undefined ? 'postgresql://dark_lkp7_user:TpUElpZE8quHcQrQC9Wq1FzakTqAuMRH@dpg-csuquoqj1k6c738iptr0-a/dark_lkp7' : process.env.POSTGRESQL_URL,
};
